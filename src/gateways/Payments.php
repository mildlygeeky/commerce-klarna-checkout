...
use ellera\commerce\klarna\models\forms\PaymentsForm;
...
class Payments extends Base
{
    ...
    public function authorize(Transaction $transaction, BasePaymentForm $form): RequestResponseInterface
    {
        ...
        /** @var $form HostedForm */
        if(!$form instanceof PaymentsForm) throw new BadRequestHttpException('Klarna Payments authorize only accepts PaymentsForm');
